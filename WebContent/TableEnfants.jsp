...
<title> Liste des Enfants Autisstes</title>
</head>
<body>
                      ...
                      <table class="table table-striped jambo_table bulk_action">
                        <thead>
                          <tr class="headings">
                            ...
                            <th class="column-title">ID_Enfant</th>
                            <th class="column-title">Nom_Enfant</th>
                            <th class="column-title">Prenom_Enfant</th>
                            <th class="column-title">Age_Enfant</th>
...
ArrayList<Enfant> list= Enfant.getAllF();
		for(int i=0;i<list.size();i++){
			...
			<td class=" "><%=list.get(i).getIdE()%></td>
			<td class=" "><%=list.get(i).getNom()%></td>
			<td class=" "><%=list.get(i).getPrenom()%></td>
			<td class=" "><%=list.get(i).getAge() %></td>
			
     <td class="center"><a href="./detailServ?id=<%= list.get(i).getIdE() %>"> <span class="btn btn-success"> Détail </span></a>
     <a href="./ResultServ?nom=<%= list.get(i).getNom() %>"> <span class="btn btn-default"> Result </span></a></td>
		<% } %>
